...
def parse_arguments(argument_override = None):
  ...
  parser.add_argument('-c', '--network_capacity', default=16, type=int, min=4, help='network capacity (default 16), lower values use less memory but produce lower quality results')
